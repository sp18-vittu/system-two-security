import DacReposFolderView from './DacReposFolderView'

function DacReposFolder({
  setModalOpen,
  selectId,
  setSelectId,
  dacFolderList,
  ...
  return (
    <div className='bg-[#1d2939] rounded-lg p-8 flex flex-col gap-6 w-full h-full overflow-scroll hide-scrollbar'>
      ...
      <div className='flex items-center justify-between'>
        <div className='text-white font-semibold text-lg'>GitHub Repos</div>
        <div onClick={() => setModalOpen(true)} className='flex items-center gap-2 cursor-pointer'>
          <svg
          ...
          <div className='text-[#ee7103] font-semibold text-md'>Add Repo</div>
        </div>
      </div>
