...
const YamlTextEditor = ({ ymltext, setSeloctror }: props) => {
  const editorRef: any = useRef(null)

  const handleYamlChange = (newValue: any) => {
  ...
  return (
    ...
    >
      <AceEditor
        ...
        mode='yaml'
        value={ymltext}
        onFocus={handleYamlChange}
        wrapEnabled={true}
        theme='twilight'
        name='yaml-editor'
        readOnly={true}
        editorProps={{ $blockScrolling: true }}
        style={{ width: '100%', height: '100%', borderRadius: "12px" }} // Make AceEditor fill the parent Box
        setOptions={{
          useWorker: false,
          useSoftTabs: true,
