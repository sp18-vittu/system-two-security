...
import { CollectionruleDelete, getallCollection } from '../../../redux/nodes/Collections/action'
...
function SigmaRule({ tablelist, paramsdata, setdeletvale }: any) {
  const { id } = useParams()
        ...
        return (
          <>
            ...
            <Menu sx={{}} anchorEl={anchorE6} open={opendot} onClose={handleClosing}>
              <div
                className={`right-0 px-5 text-[#344054] ${paramsdata == 'ctisigma' ? 'w-[240px]' : 'w-[200px]'
                  }`}
              >
                {paramsdata == 'commensigmarule' && (
                  <ul>
                    ...
                    <>
                      <button className='flex'>
                        <li className='text-sm font-medium m-1'>Clone</li>
                      </button>
                    </>
                ...
                {paramsdata == 'ctisigma' && (
                  <ul>
                    ...
                    <>
                      <button className='flex'>
                        <li className='text-sm font-medium m-1'>Copy to Detection Lab</li>
                      </button>
                    </>
                    <>
                      <button className='flex'>
  ...
  const filterdata: any = tablelist.filter(
    (collection: any) =>
        ...
        <div className='flex items-center justify-between gap-4  mt-2 w-full'>
          ...
          <div className=''>
            <div className='flex items-center space-x-2 bg-dark'>
              <div className='flex items-center bg-[#fff] p-2 rounded-md w-[376px]'>
                <input
                  type='text'
                  placeholder='Search'
          ...
          <div className='flex items-center bg-[#fff] outline-none text-[#344054] rounded-lg px-4 py-2 cursor-pointer'>
            <span className='text-md'>Filter by</span>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              width='20'
              height='20'
          ...
          <div className='flex items-center gap-4 ml-auto space-x-3'>
            ...
            <button
              className={`bg-orange-600 text-white py-1 px-4 rounded-lg ${selectedRows?.length == 0
            ...
            <button className='bg-orange-600 text-white py-1 px-4 rounded-lg'>
              Send all to Inbox
            </button>
          </div>
        </div>
