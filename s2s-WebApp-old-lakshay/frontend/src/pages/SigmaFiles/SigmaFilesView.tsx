...
import { CollectiondataCopyPost, getallCollection, getinboxCollection, yamlFileUpdate } from '../../redux/nodes/Collections/action'
...
export default function SigmaFilesView() {
  ...
  const handleOpenCollection = (data: any) => {
    ...
    setCollectionorcti(state?.paramsdata == "Threatbreif" ? "ctiThreatbreif" : state?.paramsdata)
    setDialogOpen(true)
  }
