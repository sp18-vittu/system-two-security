...
import { sanitizeChatOne } from '../../redux/nodes/chats/chatAction'
...
export default function ChatOnePage() {
  ...
  const chatValue = useSelector((state: any) => state.reducer)
  const auth = useSelector((state: any) => state.auth)
  const items = chatValue.chatResults ? chatValue.chatResults : []
  ...
  const handleSend = (event: any) => {
    ...
    queryReset()
    dispatch(sanitizeChatOne({ query: query, dateTime: new Date() }, auth.user?.email) as any)
  }
  return (
    <>
