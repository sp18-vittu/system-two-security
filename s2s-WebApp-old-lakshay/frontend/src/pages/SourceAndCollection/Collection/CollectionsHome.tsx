        ...
        <div className="sources bg-[#0f121b] relative overflow-hidden">
          ...
          <div className="chat-2-0 bg-[#1c2838] border border-[#344054] rounded-[10px] p-4 mx-auto mt-8">
            <div className="chat-bar bg-[#0f1824] border border-[#1d2939] rounded-[10px] p-4 flex flex-wrap items-center gap-4">
              ...
              <button disabled={sendmessage ? false : true} onClick={handleWebSocket} className={`chat-button2 ${sendmessage ? 'cursor-pointer' : 'cursor-not-allowed opacity-50 hover'} bg-[#ee7103] rounded-md px-4 py-2 flex items-center gap-2 cursor-pointer shadow-sm max-sm:justify-center max-sm:basis-full`}>
