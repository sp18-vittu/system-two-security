...
function NewPage() {
    ...
    return (
        ...
        <div className="box-border bg-black min-h-screen relative overflow-hidden">
            <div className="absolute left-[-930px] top-[-44px] w-[1747px] h-[1955px] bg-[rgba(243,132,14,0.35)] rounded-full blur-[500px]"></div>
            <div className="absolute left-[1360.31px] top-[-856px] w-[2020.67px] h-[948.47px] bg-[rgba(15,118,178,0.35)] rounded-full blur-[500px] origin-top-left rotate-[41.891deg] scale-100"></div>
            <svg className="absolute  top-[53px] h-auto overflow-visible" xmlns="http://www.w3.org/2000/svg" width="404" height="850" viewBox="0 0 404 850" fill="none">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M260.998 346.412L289.229 374.909L403.865 375.01V339.504L311.472 246.241H-153.01L-181.241 217.745V128.8L-153.01 100.303H284.72L312.952 128.8H402.164V93.395L335.195 0.132812H-203.484L-295.877 93.395V253.15L-203.484 346.412H260.998ZM260.998 503.576L289.229 475.079L403.865 474.978V510.484L311.472 603.746H-153.01L-181.241 632.243V721.188L-153.01 749.685H284.72L312.952 721.188H402.164V756.593L335.195 849.855H-203.484L-295.877 756.593V596.838L-203.484 503.576H260.998Z" fill="url(#paint0_radial_2874_10733)" />
                <defs>
                    <radialGradient id="paint0_radial_2874_10733" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(261.136 416.099) rotate(0.677703) scale(529.765 485.901)">
                        <stop stop-color="#FFC700" />
                        <stop offset="1" stop-color="#FF7B01" />
                    </radialGradient>
                </defs>
            </svg>
            <div className="absolute left-[928px] top-1/2 -translate-y-1/2 flex flex-col gap-4 items-center justify-start w-[880px]">
                <div className="relative w-[230px] h-[40px] flex-shrink-0">
                ...
                <div className="relative text-left text-white font-medium text-[20px] leading-[30px]">Login</div>
                <form
                    action=''
                ...
                {/*  <div className="relative flex flex-col gap-0 items-start justify-start self-stretch flex-shrink-0 rounded-[8px] shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)]">
                    <div className="relative flex flex-col gap-1.5 items-start justify-start self-stretch flex-shrink-0">
                        <div className="relative text-left text-white font-medium text-[14px] leading-[20px]">Email</div>
                        <div className="relative flex flex-row gap-2 items-center justify-start self-stretch flex-shrink-0 bg-[#182230] rounded-[8px] px-3 py-2 shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)]">
                            <div className="relative flex flex-row gap-2 items-center justify-start flex-1">
                                <div className="relative flex-1 text-left text-[#98a2b3] font-normal text-[16px] leading-[24px] truncate">Enter your email</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="relative flex flex-col gap-0 items-start justify-start self-stretch flex-shrink-0 rounded-[8px] shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)]">
                    <div className="relative flex flex-col gap-1.5 items-start justify-start self-stretch flex-shrink-0">
                        <div className="relative text-left text-white font-medium text-[14px] leading-[20px]">Password</div>
                        <div className="relative flex flex-row gap-0 items-start justify-start self-stretch flex-shrink-0 bg-[#182230] rounded-[8px] shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)]">
                            <div className="relative flex flex-row gap-2 items-center justify-start flex-1 rounded-tl-[8px] rounded-br-[8px] px-3 py-2 overflow-hidden">
                                <div className="relative flex-1 text-left text-[#98a2b3] font-normal text-[16px] leading-[24px] truncate">Enter your password</div>
                            </div>
                            <div className="relative flex flex-row gap-2 items-center justify-center flex-shrink-0 rounded-tr-[8px] rounded-bl-[8px] p-3 overflow-hidden">
                                <img className="relative w-[20px] h-[20px] flex-shrink-0 overflow-visible" src="eye-off0.svg" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="relative self-stretch text-right text-[#ffffff] font-medium text-[16px] leading-[24px]">Forget password?</div>
                <div className="relative flex flex-row gap-2 items-center justify-center self-stretch flex-shrink-0 h-[44px] bg-[#ee7103] rounded-[8px] p-2 overflow-hidden shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)]">
                    <div className="relative text-left text-[#ffffff] font-semibold text-[16px] leading-[20px]">Sign In</div>
                </div> */}
            </div>
        </div>
